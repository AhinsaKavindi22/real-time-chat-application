      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <label htmlFor="avatar" className='flex items-center gap-3 cursor-pointer'>
            ...
            <img src={seletedImg ? URL.createObjectURL(seletedImg) : assets.avatar_icon} alt="" className={`w-12 h-12 ${seletedImg && 'rounded-full'}`} />
          ...
          <textarea onChange={(e) => setBio(e.target.value)} value={bio}
            ...
            className='p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-2 fcus:ring-violet-500'></textarea>
